...
help:
	@printf '%s\n' \
		...
		'  make pilot-smoke              Run isolated local pilot verification' \
		'  make app-user-paths-check      Verify screenshot journey map' \
...
app-user-paths-check:
	node ./scripts/verify-app-user-paths.mjs

pilot-smoke:
	node ./scripts/run-local-pilot-smoke.mjs
