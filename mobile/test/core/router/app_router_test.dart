...
void main() {
  ...
  final cases =
      ...
      >[
        ...
        (
          description: 'preserves a public item deep link through onboarding',
          authState: const AuthState.unauthenticated(),
          onboardingCompleted: false,
          location: '/items/item-1',
          expected: '/onboarding?returnTo=%2Fitems%2Fitem-1',
        ),
        (
          description:
        ...
        (
          description: 'sends authenticated root to find',
          authState: const AuthState.authenticated(user: user),
          onboardingCompleted: true,
          location: '/',
          expected: '/catalog',
        ...
        (
          description: 'sends authenticated onboarding to find',
          authState: const AuthState.authenticated(user: user),
          onboardingCompleted: true,
          location: '/onboarding',
          expected: '/catalog',
        ...
        (
          description: 'sends authenticated auth routes to find',
          authState: const AuthState.authenticated(user: user),
          onboardingCompleted: true,
          location: '/auth/otp',
          expected: '/catalog',
        ...
        (
          description: 'sends unauthenticated root to the public catalog',
          authState: const AuthState.unauthenticated(),
          onboardingCompleted: true,
          location: '/',
          expected: '/catalog',
        ...
        (
          description: 'allows unauthenticated public catalog',
          authState: const AuthState.unauthenticated(),
          onboardingCompleted: true,
          location: '/catalog',
          expected: null,
        ...
        (
          description: 'allows unauthenticated public item details',
          authState: const AuthState.unauthenticated(),
          onboardingCompleted: true,
          location: '/items/item-1',
          expected: null,
        ...
        (
          ...
          onboardingCompleted: true,
          location: '/home',
          expected: '/auth/phone?returnTo=%2Fhome',
        ),
        (
          ...
          expected: '/auth/phone?returnTo=%2Fbooking%2Fbooking-1',
        ),
        (
          description: 'resumes a protected intent after authentication',
          authState: const AuthState.authenticated(user: user),
          onboardingCompleted: true,
          location: '/auth/otp?returnTo=%2Fitems%2Fitem-1%2Fbooking',
          expected: '/items/item-1/booking',
        ),
        (
          description: 'rejects an external post-auth return target',
          authState: const AuthState.authenticated(user: user),
          onboardingCompleted: true,
          location: '/auth/otp?returnTo=https%3A%2F%2Fevil.example',
          expected: '/catalog',
        ),
      ];
