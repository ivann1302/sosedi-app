...
2. После того как владелец самостоятельно подготовит новый домен и лендинг,
   создать рабочую почту на домене и проверить публичные
   support/privacy/account-deletion URL. Создание лендинга не входит в roadmap.
