# Как устроено приложение «Соседи»
...
«Соседи» — мобильный P2P-сервис, в котором один человек может сдать свою вещь
другому человеку поблизости на несколько дней. P2P означает *person to person*:
основные стороны сделки — обычные пользователи, а «Соседи» предоставляет
